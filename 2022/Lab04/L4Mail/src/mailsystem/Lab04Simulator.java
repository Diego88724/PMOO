...
public class Lab04Simulator {
	...
	public static void testMailClient() {
		...
		MailClient mailClient1 = new MailClient(insServer, "userC1");
		
		MailClient mailClient2 = new MailClient(insServer, "userC2");
		
		mailClient1.sendEmail("user2", "prueba1", "text1");
		mailClient1.sendEmail("user2", "prueba2", "text2");
		mailClient1.sendEmail("user2", "prueba3", "text3");
		
		mailClient2.sendEmail("user1", "prueba4", "text4");
